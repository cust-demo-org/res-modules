variable "data_factories" {
  ...
  default     = {}
  description = <<-EOT
    A map of Azure Data Factories to create. Each Data Factory is deployed using the AVM `Azure/avm-res-datafactory-factory/azurerm` module (v0.1.0).
...
variable "enable_telemetry" {
  description = "Default telemetry flag fallback when a Data Factory does not set enable_telemetry."
  type        = bool
  default     = true
}
...
variable "virtual_networks" {
  description = "Virtual networks output map from spoke module. Used to resolve vnet_key/subnet_key references in private endpoints."
  type        = any
  default     = {}
}

variable "managed_identities" {
  description = "Managed identities output map from spoke module. Used to resolve user_assigned_managed_identity_keys to UAMI resource IDs and role assignment principal IDs in Data Factory and private endpoints."
  type        = any
  default     = {}
}

variable "key_vaults" {
  description = "Key Vaults output map from spoke module. Used to resolve key_vault_key to Key Vault resource ID in linked services."
  type        = any
  default     = {}
}
